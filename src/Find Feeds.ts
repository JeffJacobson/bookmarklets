...
(() => {
    ...
    function createListOfFeedAnchors(): HTMLUListElement | null {
        ...
        const feedAnchors = document.querySelectorAll<HTMLAnchorElement>(feedSelector);
         ...
         */
        function* convertAnchors(anchors: NodeListOf<HTMLAnchorElement> = feedAnchors, feedNamesRe = re) {
